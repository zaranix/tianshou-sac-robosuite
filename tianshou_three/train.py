...
# =============================================================================
# 1. Environment Factory (Modern Gymnasium API)
# =============================================================================
def make_robosuite_env(task_name, seed=0, training=True, video_record=False):
    ...
    # 2. Wrap with modern Gymnasium-compatible GymWrapper
    ...
    # GymWrapper natively supports Gymnasium API (terminated, truncated)

    # Modern GymWrapper handles dtype conversions automatically
...
def train_sac(args):
    ...
    # Seeding (Gymnasium envs use reset(seed=...) instead of .seed())
